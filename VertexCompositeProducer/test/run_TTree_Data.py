...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://eos.cms.purdue.edu//store/user/awesolek/D0_DATA_Run3/HIPhysicsRawPrime0/D0_DATA_Run3/250228_170741/0000/out_112.root'),  # miniAOD file
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('outputTTree.root')
)
...
process.d0ana.doGenNtuple = cms.untracked.bool(False) #MConly
process.d0ana.doGenMatching = cms.untracked.bool(False) #MConly
